...
export const AnthropicDialog=({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent>
            <DialogHeader>
                <DialogTitle>Anthropic Request Activated</DialogTitle>
                <DialogDescription>
                    The Anthropic request has been successfully activated.
                </DialogDescription>
            </DialogHeader>
            <Form {...form}>
                                                                                 ...
                                                                                 {credentials?.map((credential)=>(
                                                                                     <SelectItem key={credential.id} value={credential.id}>
                                                                                         <div className="flex items-center gap-2 space-x-2">
                                                                                             <Image src='/logos/anthropic.svg' alt='Anthropic Logo' width={16} height={16} />
                         ...
                         <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                    this is the user prompt that will be sent to the Anthropic model.
                                    use {"{{variable}}"} to reference the output of this node in subsequent nodes
                                    or {"{{json variable}}"} to reference the output of this node in JSON format.
                                    </FormDescription>
                                    <FormMessage />
