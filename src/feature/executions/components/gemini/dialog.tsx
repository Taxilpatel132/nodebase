...
export const GeminiDialog=({
    ...
    const watchVariableName=form.watch('variableName')||"myGeminiResponse";
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent>
            <DialogHeader>
                <DialogTitle>Gemini Request Activated</DialogTitle>
                <DialogDescription>
                    The Gemini request has been successfully activated.
                </DialogDescription>
            </DialogHeader>
            <Form {...form}>
                         ...
                         <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                    this is the user prompt that will be sent to the Gemini model.
                                    use {"{{variable}}"} to reference the output of this node in subsequent nodes
                                    or {"{{json variable}}"} to reference the output of this node in JSON format.
                                    </FormDescription>
                                    <FormMessage />
